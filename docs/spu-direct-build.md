...
光送信基板1枚分。Tang Nano 9K、対応USBケーブル、ユニバーサル基板は既存品／別途選定を前提とする。
...
| 測定用・任意 | [107591 チェック端子TEST-1(BK)](https://akizukidenshi.com/catalog/g/g107591/) | 3 | 10個入×1パック | 3V3、GND、Vin用。図の各ネットへ接続しラベルを付ける。ヘッダーで代用可 |
...
- ユニバーサル基板、固定ねじ・ナット：別途の選定結果に合わせる。PLTの信号端子ピッチだけでなく固定脚と外形、必要な穴を照合する。
